...
const samplePoems = {
  ...
  ci: [
    { title: "念奴娇·赤壁怀古", content: "大江东去，\n浪淘尽，\n千古风流人物。\n故垒西边，\n人道是，\n三国周郎赤壁。", author: "苏轼" },
    { title: "雨霖铃", content: "寒蝉凄切，\n对长亭晚，\n骤雨初歇。\n都门帐饮无绪，\n留恋处，\n兰舟催发。", author: "柳永" },
  ],
  fu: [
    { title: "前赤壁赋", content: "壬戌之秋，\n七月既望，\n苏子与客泛舟游于赤壁之下。\n清风徐来，\n水波不兴。", author: "苏轼" },
    { title: "洛神赋", content: "黄初三年，\n余朝京师，\n还济洛川。\n古人有言，\n斯水之神，\n名曰宓妃。", author: "曹植" },
  ],
  qu: [
    { title: "山坡羊·潼关怀古", content: "峰峦如聚，\n波涛如怒，\n山河表里潼关路。\n望西都，\n意踌躇。", author: "张养浩" },
    { title: "天净沙·秋思", content: "枯藤老树昏鸦，\n小桥流水人家，\n古道西风瘦马。\n夕阳西下，\n断肠人在天涯。", author: "马致远" },
  ]
};

// Function to randomly select poems based on style
function getRandomPoem(style: string, prompt: string): PoemResponse {
  const styleSamples = samplePoems[style as keyof typeof samplePoems] || samplePoems.shi;
...
// Mock API service
export async function generatePoem(request: GeneratePoemRequest): Promise<PoemResponse> {
  // Simulate API delay
